...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Aadi shankar Das')
    ...
    GAME_SPRITES['message'] = pygame.image.load('Back gorund image - Copy.png').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('gorund image.jpg').convert_alpha()
    ...
    GAME_SOUNDS['points'] = pygame.mixer.Sound('points.wav')
